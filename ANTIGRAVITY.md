# Antigravity Instructions — Shim

> **Canonical conventions live in [`AGENTS.md`](AGENTS.md).** Read it first.
> This file contains **only Antigravity-specific runtime guidance** (tool-use rules, response style, approved commands). Architecture, modules, API conventions, Eloquent, security, and the full skill catalog all live in the canonical doc.
