# Agent Instructions — Gemini Shim

> **Canonical conventions live in [`../AGENTS.md`](../AGENTS.md).** Read it first.
> This file is a thin shim for Gemini reading from `.gemini/`. It contains only the **skill catalog pointer** + folder map.
...
- Laravel 12 API with PostgreSQL + Redis + Reverb + Queues
- Flutter-compatible trip/driver/delivery paths
- Bilingual responses and idempotency middleware for offline sync
